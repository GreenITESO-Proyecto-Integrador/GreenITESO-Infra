...
- Actualización de ramas draft contra Backend `origin/dev` `771407c19355fb5a983b743c7ff726073e20a098` (ASGI, sin migración nueva): PR #30 `5e608f1ae8e557f60736eb819a9c2e84d64ac30a` (215 tests PostgreSQL, contrato de release en CI, guía de concurrencia ASGI corregida), PR #33 `f67db49c96c3a5f27b06855f6f05cd39111adabe` (271 tests) y revisión posterior de textos `5b5b5ce8f6d5befdbc84dbebefa1bd34af0cd4bc` (27 tests enfocados, catálogo candidato DRAFT/inactivo, sin clanes), PR #34 `970c3f5742a34e7c4c9ad18bf0f1f8148cc47384` (239 tests) y PR #101 `107c629bd1f751b7aa98857242a25e429db6fe0f` (P10, 218 tests). Opus 5.5 aprobó cada SHA exacto antes de su push. Los checks de GitHub de PR #30, #34, #101 y del head anterior `f67db49` de PR #33 pasaron; el head `5b5b5ce` requiere verificación final de CI. Ninguna PR se fusionó por este trabajo. El [candidato de Product](https://github.com/GreenITESO-Proyecto-Integrador/GreenITESO-Backend/blob/5b5b5ce8f6d5befdbc84dbebefa1bd34af0cd4bc/docs/catalog-candidate-v1.json) tiene SHA-256 de propuesta `d68c80544c17a2bed82db099e6463735ef2ba6d2f71ab4ace4c4ad748be0071e` (no es pin de release). Los datos demo y el catálogo aprobado no se cargaron en Neon. El candidato sigue pendiente de Product y E2 para mapeo canónico de carreras. El ensayo PITR sigue bloqueado por el dataset aprobado y la revisión de seguridad de `neon_auth.project_config` heredada. No se consultó ni modificó production.
