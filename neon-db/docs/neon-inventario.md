...
- El smoke ampliado de un commit **local aún no publicado**, hijo del draft Backend PR30, se ejecutó en modo lectura con los roles app pooled de dev y staging el **2026-09-25**: ambas ramas reportaron 23 tablas públicas, nueve secuencias y denegación DDL. Véase [evidencia sin secretos](evidence/neon-app-smoke-2026-09-25.md). No es evidencia de migración por CI, Cloud Run ni production.
